...
public class UpdateEmployeeFrame extends JFrame {
	...
	// Components
	private JLabel lbl_id, lbl_fn, lbl_ln, lbl_em, lbl_department;
	private JTextField txt_id, txt_fn, txt_ln, txt_em;
	private JComboBox<String> txt_department;
	private JButton btn_cancel, btn_update;

	public UpdateEmployeeFrame(DatabaseManager dbManager) {
		...
		btn_update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (dbManager.existsEmployeeID(id)) {
						dbManager.updateEmployee(id, fn, ln, email, department);
						setVisible(false);
