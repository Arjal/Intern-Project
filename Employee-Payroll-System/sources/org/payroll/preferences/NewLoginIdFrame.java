...
public class NewLoginIdFrame extends JFrame {
	...
	public NewLoginIdFrame(DatabaseManager dbManager) {
	...
	void addActionListeners() {
		...
		final JTextField finalTxtUsername = txt_username;
		btn_create.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (isUsernameValid()) {
					if (!dbManager.verifyLoginId(txt_username.getText(), new String(txt_newPassword.getPassword()))) {
						if (Arrays.equals(txt_newPassword.getPassword(), txt_repeatPassword.getPassword())) {
							if (isStrongPassword()) {
								dbManager.createLoginId(NewLoginIdFrame.this.txt_username.getText(), new String(txt_newPassword.getPassword()));
								setVisible(false);
