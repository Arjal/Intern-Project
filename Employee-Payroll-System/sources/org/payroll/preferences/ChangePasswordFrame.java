...
public class ChangePasswordFrame extends JFrame {
	...
	public ChangePasswordFrame(String username, DatabaseManager dbManager) {
	...
	void addActionListeners() {
		...
		btn_OK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (dbManager.verifyLoginId(username, new String(txt_oldPassword.getPassword())))
					if (Arrays.equals(txt_newPassword.getPassword(), txt_repeatPassword.getPassword()))
						if (isStrongPassword(new String(txt_newPassword.getPassword()))) {
							dbManager.changePassword(username, new String(txt_newPassword.getPassword()));
							setVisible(false);
