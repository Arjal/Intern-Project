...
public class ModifyDepartmentFrame extends JFrame {
	...
	public ModifyDepartmentFrame(DatabaseManager dbManager) {
	...
	void initComponents() {
		departments = dbManager.getListOfDepartments(); // Update the list of departments
		...
		btn_create.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (dbManager.existsDepartment(dep_name)) {
						dbManager.updateDepartment(dep_name, basic_salary, da, hra, pf);
						setVisible(false);
